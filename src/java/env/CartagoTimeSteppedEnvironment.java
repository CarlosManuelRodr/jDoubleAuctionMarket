 ...
 *
 */
public class CartagoTimeSteppedEnvironment extends TimeSteppedEnvironment {

	private static CartagoTimeSteppedEnvironment instance;
	...
	static Logger logger = Logger.getLogger(CartagoTimeSteppedEnvironment.class.getName());
	...
	public void init(String[] args) {
		...
		if (standalone){
			...
			try {
				CartagoService.startNode();
				int nprots = checkProtocols(args);
	 ...
	 * @return
	 */
	public static CartagoTimeSteppedEnvironment getInstance(){
		return instance;
	}
