 ...
 *
 */
public class CustomTimeSteppedEnvironment extends Environment {

    private Logger logger = Logger.getLogger(CustomTimeSteppedEnvironment.class.getName());
    ...
    public CustomTimeSteppedEnvironment() {
        super(2);
    }
